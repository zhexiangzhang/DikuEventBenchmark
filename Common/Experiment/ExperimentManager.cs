...
public abstract class ExperimentManager
{
    ...
    protected abstract Task RunIngestion(DuckDBConnection connection);
    ...
    public async Task Run()
    {
        ...
        foreach (var run in config.runs)
        {
            ...
            Console.WriteLine("ready to preWorkload");
            PreWorkload(runIdx);
            Console.WriteLine("preWorkload Done");
