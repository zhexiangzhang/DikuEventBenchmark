...
namespace Common.DataGeneration
{
	public abstract class BaseDataGenerator
	{
        ...
        {
            Console.WriteLine("BaseGen - productId: " + productId + ", sellerId: " + sellerId + ", category: " + category);
            ...
            command.CommandText = sb.ToString();
            Console.WriteLine("pass   "+command.CommandText+"\n");
            try {
                command.ExecuteNonQuery();
            }
            catch (Exception e) { 
                Console.WriteLine(e.Message); 
                Console.WriteLine("fail    "+command.CommandText+"\n");
                throw e;
            }
            
            // Console.WriteLine("Hi. I m finished");
        }
